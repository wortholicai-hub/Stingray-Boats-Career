  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] flex flex-col">
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative text-center px-6 mb-12">
          ...
          >
            ...
            <p className="text-white/90 text-lg md:text-xl max-w-lg mx-auto font-bold">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-5">
          ...
          <div className="flex gap-2 mb-4">
            <button
              ...
              className={`px-5 py-2.5 rounded-lg text-base font-bold transition-all duration-200 cursor-pointer ${
                viewMode === "positions"
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-lg text-base font-bold transition-all duration-200 cursor-pointer flex items-center gap-2 ${
                viewMode === "locations"
                  ? "bg-[#004D6D] text-white shadow-md"
                  : "bg-[#f5f6f8] text-[#18344C]/60 hover:text-[#18344C] hover:bg-[#e8ebef]"
              }`}
          ...
          <div className="flex flex-col lg:flex-row items-end gap-3">
            <div className="flex-1 w-full lg:w-auto">
              <label className="text-sm font-bold text-[#18344C] uppercase tracking-wider mb-1 block">
                Search by keyword
              </label>
              <input
                type="text"
            ...
            <div className="relative w-full lg:w-auto" ref={workEnvRef}>
              <label className="text-xs font-bold text-[#18344C]/70 uppercase tracking-wider mb-1 block lg:invisible">Filter</label>
              <button
              ...
              >
                ...
                {workEnv.length > 0 && (
                  <span className="bg-[#6FAEDF] text-white text-xs px-1.5 py-0.5 rounded-full min-w-[18px] text-center">{workEnv.length}</span>
                )}
                ...
                <div className="absolute top-full left-0 mt-1 bg-white border border-[#C5CCD5] rounded-lg shadow-lg z-20 min-w-[240px]">
                  <div className="p-2">
                    <div className="flex items-center justify-between px-3 py-2 border-b border-[#C5CCD5]/30 mb-1">
                      ...
                      {workEnv.length > 0 && <button onClick={() => setWorkEnv([])} className="text-sm text-[#18344C]/60 hover:text-[#18344C] cursor-pointer">Clear</button>}
                    </div>
            ...
            <div className="relative w-full lg:w-auto" ref={hotJobRef}>
              ...
              >
                <span>Hot Job</span>
                {hotJob.length > 0 && (
                  <span className="bg-[#6FAEDF] text-white text-xs px-1.5 py-0.5 rounded-full min-w-[18px] text-center">{hotJob.length}</span>
                )}
            ...
            <div className="w-full lg:w-auto">
              <label className="text-xs font-bold text-[#18344C]/70 uppercase tracking-wider mb-1 block lg:invisible">Action</label>
              <button className="w-full lg:w-auto bg-[#004D6D] text-white font-bold px-6 py-3 rounded-lg hover:bg-[#18344C] transition-colors text-base tracking-wide cursor-pointer whitespace-nowrap" style={{ fontFamily: buttonFont }}>
                Filter Jobs
              </button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 w-full mt-4 relative z-20">
        <div className="rounded-xl p-4 flex items-center gap-4" style={{ background: "linear-gradient(135deg, #18344C 0%, #004D6D 100%)" }}>
          <div className="w-10 h-10 bg-[#6FAEDF]/15 rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-start gap-3 flex-1">
              <div className="w-10 h-10 bg-[#6FAEDF]/15 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-5 h-5 text-[#6FAEDF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7H4a1 1 0 00-1 1v10a2 2 0 002 2h14a2 2 0 002-2V8a1 1 0 00-1-1zM16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2" />
                </svg>
              </div>
            ...
            <button
              ...
              className="bg-[#6FAEDF] text-[#18344C] font-bold px-6 py-3 rounded-lg hover:bg-white transition-colors text-base whitespace-nowrap cursor-pointer shadow-lg shadow-black/10"
              style={{ fontFamily: buttonFont }}
            >
              Create Job Alerts
            </button>
        ...
        {selectedJob !== null ? (
              ...
              <div className="bg-white rounded-xl border border-[#C5CCD5]/30 overflow-hidden">
                ...
                <div className="px-6 md:px-8 py-4 md:py-5 border-b border-[#C5CCD5]/20" style={{ background: "linear-gradient(135deg, #18344C 0%, #004D6D 100%)" }}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-white text-[#18344C] shadow-sm">{job.type}</span>
                    <button onClick={() => setSelectedJob(null)} className="flex items-center gap-2 text-[#6FAEDF] text-base font-bold hover:text-white transition-colors cursor-pointer" style={{ fontFamily: buttonFont }}>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div>
                      <h1 className="text-3xl md:text-4xl text-white font-black uppercase tracking-tight" style={{ fontFamily: headingFont }}>{job.title}</h1>
                      <div className="flex items-center gap-2 mt-2 text-white/90">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                        <span className="text-base font-bold">{job.company} | {job.location}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8">
                  <div className="grid md:grid-cols-[1fr_280px] gap-8">
                    <div>
                      <h2 className="text-xl font-bold text-[#18344C] mb-4" style={{ fontFamily: headingFont }}>Job Summary</h2>
                      <p className="text-[#18344C] text-base leading-relaxed mb-6 font-bold">{job.description}</p>

                      <h2 className="text-xl font-bold text-[#18344C] mb-4" style={{ fontFamily: headingFont }}>Responsibilities</h2>
                      <ul className="space-y-2.5 mb-6">
                        {["Receive, unload, and process incoming shipments accurately", "Organize and maintain inventory in designated warehouse areas", "Pick, pack, and prepare orders for shipment", "Operate warehouse equipment such as forklifts and pallet jacks", "Perform regular inventory counts and reconcile discrepancies", "Maintain a clean, safe, and organized work environment", "Collaborate with team members to meet daily operational goals"].map((item, i) => (
                          <li key={i} className="flex items-start gap-2.5 text-base text-[#18344C]">
                      ...
                      <h2 className="text-xl font-bold text-[#18344C] mb-4" style={{ fontFamily: headingFont }}>Requirements</h2>
                    ...
                    <div className="space-y-5">
                      <div className="bg-[#f5f6f8] rounded-xl p-5">
                        <h3 className="text-lg font-bold text-[#18344C] mb-3" style={{ fontFamily: headingFont }}>Job Details</h3>
                        <div className="space-y-3">
                          {[{ label: "Company", value: job.company }, { label: "Location", value: job.location }, { label: "Job Type", value: job.type }, { label: "Department", value: "Manufacturing" }].map((d) => (
                            <div key={d.label}>
                              <div className="text-sm font-bold text-[#18344C]/70 uppercase tracking-wider">{d.label}</div>
                              <div className="text-base text-[#18344C] font-bold">{d.value}</div>
                            </div>
                          ))}
                        </div>
                      </div>
                      <button onClick={() => { setShowQuickApply(true); setQuickApplyView("apply"); }} className="w-full bg-[#004D6D] text-white font-bold py-3 rounded-lg hover:bg-[#18344C] transition-colors text-base tracking-wide cursor-pointer" style={{ fontFamily: buttonFont }}>
                        Quick Apply
                      </button>
                    </div>
                  </div>
          ...
          <motion.div key="positions" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              ...
              {jobs.map((job, index) => (
                <div key={index} onClick={() => setSelectedJob(index)} className="bg-white rounded-xl p-6 border border-[#C5CCD5]/30 hover:border-[#6FAEDF]/50 hover:shadow-md hover:translate-x-1 transition-all duration-300 cursor-pointer group">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-3">
                    <div>
                      <h3 className="text-xl font-bold text-[#004D6D] group-hover:text-[#6FAEDF] transition-colors" style={{ fontFamily: headingFont }}>{job.title}</h3>
                      <div className="flex items-center gap-2 mt-1.5">
                        <svg className="w-3.5 h-3.5 text-[#C5CCD5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <p className="text-base text-[#18344C]">{job.company} | {job.location}</p>
                      </div>
                    </div>
                    <span className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-bold bg-[#6FAEDF]/10 text-[#004D6D] whitespace-nowrap self-start">{job.type}</span>
                  </div>
                  <p className="text-base text-[#18344C] leading-relaxed line-clamp-2">{job.description}</p>
            ...
            <div className="mt-6 flex items-center justify-between">
              <div className="text-sm text-[#18344C]/60 font-medium">{jobs.length} Result{jobs.length !== 1 ? "s" : ""}</div>
          ...
          <motion.div key="locations" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-14 h-14 bg-[#6FAEDF]/15 rounded-xl flex items-center justify-center">
                <svg className="w-7 h-7 text-[#004D6D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7H4a1 1 0 00-1 1v10a2 2 0 002 2h14a2 2 0 002-2V8a1 1 0 00-1-1zM16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2" />
                </svg>
              </div>
              <div>
                <h2 className="text-3xl text-[#18344C] tracking-tight uppercase font-black" style={{ fontFamily: headingFont }}>Job Locations</h2>
                <p className="text-[#18344C] text-lg font-bold">Find open positions near you</p>
              </div>
            </div>
            <div className="grid lg:grid-cols-[1fr_380px] gap-6">
              ...
              <div className="flex flex-col">
                <div className="mb-4">
                  <label className="text-base font-bold text-[#18344C] uppercase tracking-wider mb-1.5 block">Search by job title</label>
                ...
                <div className="flex-1 space-y-3 overflow-y-auto max-h-[320px] pr-1">
                  {jobs.filter((job) => job.title.toLowerCase().includes(mapSearch.toLowerCase())).map((job, index) => (
                    <div key={index} onClick={() => setSelectedJob(index)} className="bg-[#f5f6f8] rounded-xl p-4 border border-transparent hover:border-[#6FAEDF]/40 hover:bg-[#6FAEDF]/5 transition-all cursor-pointer group">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <h4 className="font-bold text-[#004D6D] text-base group-hover:text-[#6FAEDF] transition-colors" style={{ fontFamily: headingFont }}>{job.title}</h4>
                        <span className="text-sm font-bold bg-[#6FAEDF]/10 text-[#004D6D] px-3 py-1 rounded-full whitespace-nowrap">{job.type}</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-base text-[#18344C]">
                  ...
                  {jobs.filter((job) => job.title.toLowerCase().includes(mapSearch.toLowerCase())).length === 0 && (
                    <div className="text-center py-8 text-[#18344C]/60 text-sm">No jobs found matching your search.</div>
                  )}
                </div>
                <div className="mt-4 pt-3 border-t border-[#C5CCD5]/30 flex items-center justify-between">
                  <p className="text-base text-[#18344C]"><span className="font-bold text-[#004D6D]">{jobs.filter((job) => job.title.toLowerCase().includes(mapSearch.toLowerCase())).length}</span> Result</p>
                  <div className="flex items-center gap-1.5 text-sm text-[#18344C]/60">
                    <span>Show:</span>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto modal-scroll">
            <div className="p-6 md:p-8">
              {/* Close button */}
              <div className="flex items-center justify-between mb-2">
                <h2 className="text-2xl font-black text-[#18344C] uppercase tracking-tight" style={{ fontFamily: headingFont }}>
              ...
              {modalView === "create" ? (
                <>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-base font-bold text-[#18344C] mb-1.5 block">Legal First Name <span className="text-red-500">*</span></label>
                      ...
                      <div>
                        <label className="text-base font-bold text-[#18344C] mb-1.5 block">Legal Last Name <span className="text-red-500">*</span></label>
                        <input type="text" className="w-full px-3 py-2.5 border border-[#C5CCD5] rounded-lg text-sm text-[#18344C] focus:outline-none focus:border-[#6FAEDF] focus:ring-2 focus:ring-[#6FAEDF]/20 transition-all" />
                      </div>
                    </div>
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Email Address <span className="text-red-500">*</span></label>
                    ...
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Confirm Email <span className="text-red-500">*</span></label>
                      <input type="email" className="w-full px-3 py-2.5 border border-[#C5CCD5] rounded-lg text-sm text-[#18344C] focus:outline-none focus:border-[#6FAEDF] focus:ring-2 focus:ring-[#6FAEDF]/20 transition-all" />
                    </div>
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Password <span className="text-red-500">*</span></label>
                    ...
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Confirm Password <span className="text-red-500">*</span></label>
                      <input type="password" className="w-full px-3 py-2.5 border border-[#C5CCD5] rounded-lg text-sm text-[#18344C] focus:outline-none focus:border-[#6FAEDF] focus:ring-2 focus:ring-[#6FAEDF]/20 transition-all" />
                    </div>
                  </div>
                  <p className="text-base text-[#18344C] mt-5 text-center">
                  ...
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-[#C5CCD5]/30">
                    <button onClick={() => { setShowAlertModal(false); setModalView("create"); }} className="px-6 py-2.5 text-base font-bold text-[#18344C]/70 hover:text-[#18344C] rounded-lg hover:bg-[#f5f6f8] transition-all cursor-pointer" style={{ fontFamily: buttonFont }}>
                      Cancel
                    </button>
                    <button className="px-6 py-2.5 text-base font-bold bg-[#004D6D] text-white rounded-lg hover:bg-[#18344C] transition-colors cursor-pointer shadow-md" style={{ fontFamily: buttonFont }}>
                      Next
                    </button>
                  </div>
                </>
                ...
                <>
                  ...
                  <div className="mt-6 space-y-2 text-center">
                    <p className="text-base text-[#18344C]">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto modal-scroll">
            <div className="p-6 md:p-8">
              ...
              {quickApplyView === "apply" ? (
                <>
                  <p className="text-sm font-bold text-[#6FAEDF] uppercase tracking-wider mb-5">Contact Information</p>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-base font-bold text-[#18344C] mb-1.5 block">Legal First Name <span className="text-red-500">*</span></label>
                    ...
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Primary Phone Number</label>
                    ...
                    {/* SMS Consent */}
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-2 block">
                    ...
                    {/* Resume Upload */}
                    <div>
                      <label className="text-base font-bold text-[#18344C] mb-1.5 block">Resume/CV</label>
                      <div className="border-2 border-dashed border-[#C5CCD5] rounded-lg p-5 text-center hover:border-[#6FAEDF] transition-colors">
                        ...
                        <label className="cursor-pointer">
                          ...
                          <span className="text-base text-[#18344C]"> or drag and drop</span>
                          <input type="file" accept=".pdf,.doc,.docx" className="hidden" />
                        </label>
                        <p className="text-sm text-[#18344C]/60 mt-1">Max 1 file per upload (5.00 MB size limit per file)</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-[#C5CCD5]/30">
                    <button onClick={() => { setShowQuickApply(false); setQuickApplyView("apply"); }} className="px-6 py-2.5 text-base font-bold text-[#18344C]/70 hover:text-[#18344C] rounded-lg hover:bg-[#f5f6f8] transition-all cursor-pointer" style={{ fontFamily: buttonFont }}>Cancel</button>
                    <button className="px-6 py-2.5 text-base font-bold bg-[#004D6D] text-white rounded-lg hover:bg-[#18344C] transition-colors cursor-pointer shadow-md" style={{ fontFamily: buttonFont }}>Next</button>
                  </div>
                </>
                ...
                <>
                  ...
                  <div className="mt-6 space-y-2 text-center">
                    <p className="text-base text-[#18344C]">Don&apos;t have an account yet?{" "}<button onClick={() => setQuickApplyView("create")} className="text-[#6FAEDF] font-semibold hover:text-[#004D6D] transition-colors cursor-pointer">Create Account</button></p>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-[#C5CCD5]/30">
                    <button onClick={() => setQuickApplyView("apply")} className="px-6 py-2.5 text-base font-bold text-[#18344C]/70 hover:text-[#18344C] rounded-lg hover:bg-[#f5f6f8] transition-all cursor-pointer" style={{ fontFamily: buttonFont }}>Cancel</button>
                    <button className="px-6 py-2.5 text-base font-bold bg-[#004D6D] text-white rounded-lg hover:bg-[#18344C] transition-colors cursor-pointer shadow-md" style={{ fontFamily: buttonFont }}>Sign In</button>
                  </div>
                </>
              ) : (
                <>
                  <p className="text-[#18344C] text-base leading-relaxed mb-6 font-bold mt-2">Create an account to apply and track your applications.</p>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-base font-bold text-[#18344C] mb-1.5 block">Legal First Name <span className="text-red-500">*</span></label>
                  ...
                  <p className="text-base text-[#18344C] mt-5 text-center">Already have an account?{" "}<button onClick={() => setQuickApplyView("signin")} className="text-[#6FAEDF] font-semibold hover:text-[#004D6D] transition-colors cursor-pointer">Sign In</button></p>
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-[#C5CCD5]/30">
                    <button onClick={() => setQuickApplyView("apply")} className="px-6 py-2.5 text-base font-bold text-[#18344C]/70 hover:text-[#18344C] rounded-lg hover:bg-[#f5f6f8] transition-all cursor-pointer" style={{ fontFamily: buttonFont }}>Cancel</button>
                    <button className="px-6 py-2.5 text-base font-bold bg-[#004D6D] text-white rounded-lg hover:bg-[#18344C] transition-colors cursor-pointer shadow-md" style={{ fontFamily: buttonFont }}>Next</button>
                  </div>
            ...
            <div className="p-6 md:p-8">
              ...
              {talentView === "create" ? (
                <>
                  ...
                  <p className="text-sm font-bold text-[#6FAEDF] uppercase tracking-wider mb-4">Account Creation Details</p>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-base font-bold text-[#18344C] mb-1.5 block">Legal First Name <span className="text-red-500">*</span></label>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-5 border-t border-[#C5CCD5]/30">
                    <button onClick={() => { setShowTalentModal(false); setTalentView("create"); }} className="px-6 py-2.5 text-base font-bold text-[#18344C]/70 hover:text-[#18344C] rounded-lg hover:bg-[#f5f6f8] transition-all cursor-pointer" style={{ fontFamily: buttonFont }}>Cancel</button>
                    <button className="px-6 py-2.5 text-base font-bold bg-[#004D6D] text-white rounded-lg hover:bg-[#18344C] transition-colors cursor-pointer shadow-md" style={{ fontFamily: buttonFont }}>Next</button>
                  </div>
                </>
              ) : (
